...
init(){
    ...
    systemctl enable postfix dovecot amavisd spamassassin fail2ban php-fpm nginx firewalld nscd
    
    # systemctl restart mysqld php-fpm nginx postfix dovecot fail2ban spamassassin nscd
    systemctl restart php-fpm nginx postfix dovecot fail2ban spamassassin nscd
